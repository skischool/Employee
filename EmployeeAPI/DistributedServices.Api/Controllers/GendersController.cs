...
namespace DistributedServices.Api.Controllers
{
    public class GendersController : ApiController
    {
        ...
        {
            _service = IoCFactory.Resolve<IGenderRepository>();
        }
        ...
        public HttpResponseMessage Post([FromBody]Gender item, [FromUri]string clientToken)
        {
            if (item == null)
        ...
        public HttpResponseMessage Put([FromUri]int id, [FromBody]Gender item, [FromUri]string clientToken)
        {
            if (item == null)
                return Request.CreateResponse(HttpStatusCode.OK, new Gender());
